...
[`docs/Codex-context/README.md`](docs/Codex-context/README.md).** Ele
...
- Nunca assumir que Série 99 é documento fiscal SEFAZ — ela é venda
  **gerencial** real, não fiscal (ver `docs/Codex-context/fiscal-e-vendas.md`).
...
- `docs/Codex-context/` — este índice de contexto (arquitetura, decisões,
