-- GAP DE VERSIONAMENTO — fn_baixar_titulo nunca teve migration em
-- supabase/migrations/, só em migrations/fn_baixar_titulo.sql (pasta solta,
-- fora do pipeline: scripts/localdb-reset.mjs nunca aplica migrations/). RPC
-- já usada de verdade por PATCH /api/financeiro/contas/:id/baixa
-- (src/routes/financeiro.js) e citada como pendente em
-- 20260101000035_baixas_financeiras_e_ledger_netvision.sql e na PR #77.
-- CREATE OR REPLACE já é idempotente por natureza — corpo abaixo é o mesmo
-- texto de migrations/fn_baixar_titulo.sql, nenhuma linha de lógica alterada.
--
